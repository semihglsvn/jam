...
public partial class GameManager : Node
{
	...
	// --- YENİ EKLENEN: Zorluk ve Hızlanma Ayarları ---
	[Export] public float HizlanmaMiktari = 4f; // Eskiden 20'ydi! (Her skorda ne kadar hızlanacak)
	[Export] public float DusmanZorlasmaMiktari = 0.02f; // Eskiden 0.10'du (Düşmanlar ne kadar çabuk sıklaşacak)
	// -------------------------------------------------
