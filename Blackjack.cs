...
public partial class Blackjack : Control
{
    ...
    [Export] public Button GoToSlotsBtn; 
    ...
    [Export] public AudioStreamPlayer CardDealSFX;
    [Export] public AudioStreamPlayer ChipClinkSFX;
    [Export] public AudioStreamPlayer WinSFX;
    [Export] public AudioStreamPlayer LoseSFX;
    [Export] public AudioStreamPlayer BustSFX;
    ...
    private void UpdateVisualChips()
    {
        ...
        // --- NEW: Play the Chip Clink SFX once when the stack changes ---
        if (ChipClinkSFX != null) ChipClinkSFX.Play();
    ...
    private void DealCard(List<PlayingCard> hand, HBoxContainer uiContainer)
    {
        ...
        // --- NEW: Play the card deal slide sound ---
        if (CardDealSFX != null) CardDealSFX.Play();
    ...
    private async void ResolveDealerTurn()
    {
        ...
        // --- NEW: Play Card Flip SFX for revealing the hidden card ---
        if (CardDealSFX != null) CardDealSFX.Play();
    ...
    private void EvaluateWinners()
    {
        ...
        bool playedBust = false;

        // Check Hand 1
        if (h1Score > 21) 
        {
            resultText += "Hand 1: BUST. ";
            playedBust = true;
        }
        ...
        {
            if (BustSFX != null) BustSFX.Play();
        }
        else if (!playedWin && !playedBust) 
        {
            // If we didn't explicitly win or explicitly bust, it's a standard loss or push
